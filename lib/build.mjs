				...
				children: (0, react_jsx_runtime.jsxs)("div", { children: [
					...
					(0, react_jsx_runtime.jsxs)("div", { className: "dsh-wtp-dialog-actions", children: [
						...
						(0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: "dsh-wtp-btn-primary",
							disabled: busy || (creating ? !nameValid : selected === "" || selected === current),
							onClick: switchTo,
							children: busy ? t("wtp.busySwitching") : creating ? t("wtp.createBranchSwitch") : t("wtp.switchTo")
						})
					] })
				] })
			});
...
const ZH_KEYS = [
  ...
  '"wtp.createBranchSwitch": "创建分支并切换"',
...
const EN_KEYS = [
  ...
  '"wtp.createBranchSwitch": "Create & switch"',
