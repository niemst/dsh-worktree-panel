		...
		*/
		...
		function __wtpEnsureCss() {
			...
			tag.textContent = [
				...
				".dsh-wtp-dialog-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:12px}",
				...
				".dsh-wtp-nested{margin-left:24px;padding-left:10px;border-left:1px solid var(--dsw-alias-border-l2,rgba(0,0,0,.08));animation:dsh-wtp-nested-in .14s ease}",
		...
		function __wtpApi() {
			...
			return {
				...
				switchMain: (repo, branch) => post("/worktrees/switch", { repo, branch }),
				...
				children: (0, react_jsx_runtime.jsxs)("div", { children: [
					...
					(0, react_jsx_runtime.jsxs)("div", { className: "dsh-wtp-dialog-actions", children: [
						...
						(0, react_jsx_runtime.jsx)("button", {
							...
							disabled: busy !== null || (name.trim() === "" ? !selected : !nameValid),
							onClick: submit,
		...
		function __wtpSwitchDialog({ repo, onClose, wtp, t }) {
			var worktrees = new Set((repo.worktrees || []).map((w) => w.name));
			var candidates = (repo.branches || []).filter((b) => !worktrees.has(b));
			var current = repo.branch;
			var [selected, setSelected] = (0, react.useState)(current);
			var [busy, setBusy] = (0, react.useState)(false);
			var [error, setError] = (0, react.useState)(null);
			var noTarget = candidates.length <= 1;
			var switchTo = () => {
					...
					noTarget
						...
						: (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							...
							(0, react_jsx_runtime.jsx)("select", {
								...
								children: candidates.map((b) => (0, react_jsx_runtime.jsx)("option", {
									value: b,
									children: b === current ? b + "（" + t("wtp.currentBranch") + "）" : b
								}, b))
							}),
